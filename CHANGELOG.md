...
## [0.1.12](https://github.com/apix-sh/cli/compare/v0.1.11...v0.1.12) - 2026-03-19

### Added

- add sub-command "tree"

## [0.1.11](https://github.com/apix-sh/cli/compare/v0.1.10...v0.1.11) - 2026-03-19

### Fixed

- improve parsing compatibility for oas auth info

### Other

- update README

## [0.1.10](https://github.com/apix-sh/cli/compare/v0.1.9...v0.1.10) - 2026-03-15

### Added

- complete OpenAPI 3.1 parser migration and docs updates

### Fixed

- fix markdown table cells for multiline content

## [0.1.9](https://github.com/apix-sh/cli/compare/v0.1.8...v0.1.9) - 2026-03-08

### Fixed

- Remove unnecessary blank lines from markdown tables in schema and route templates.
